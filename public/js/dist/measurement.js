  ...
  render: function(){
    ...
    if(this.props.measurement) {
      ...
      keys = Object.keys(this.props.measurement).map(function(key){
        return(React.createElement("option", {value: key, key: index++}, key))
      });
    }
    ...
    return (
      React.createElement("div", {className: "field"}, 
        ...
        React.createElement("select", {className: "ui select dropdown"}, 
...
var GraphType = React.createClass({displayName: "GraphType",
  render: function(){
    var types = ['bar', 'line'];
    var index = 0;
    var _selectTypes = types.map(function(type){
      return(React.createElement("option", {value: type, key: index++}, type))
    });

    return (
      React.createElement("div", {className: "field"}, 
        React.createElement("label", null, this.props.label), 
        React.createElement("select", {className: "ui select dropdown"}, _selectTypes)
      )
    );
  }
});
  ...
  render: function() {
    return (
      React.createElement("div", {className: "graphConfiguration"}, 
        ...
        React.createElement("button", {className: "ui primary button centered", onClick: this.buildGraph}, "Build Graph")
        )
      )
    );
  }
